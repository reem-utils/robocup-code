"""autogenerated by genpy from tibi_dabo_msgs/guideGoalAction.msg. Do not edit."""
import sys
...
class guideGoalAction(genpy.Message):
  _md5sum = "c4ad03327a4c5874a04413ed36029166"
  _type = "tibi_dabo_msgs/guideGoalAction"
...
"""
  ...
  _slot_types = ['tibi_dabo_msgs/guideGoalActionGoal','tibi_dabo_msgs/guideGoalActionResult','tibi_dabo_msgs/guideGoalActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(guideGoalAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = tibi_dabo_msgs.msg.guideGoalActionGoal()
      if self.action_result is None:
        self.action_result = tibi_dabo_msgs.msg.guideGoalActionResult()
      if self.action_feedback is None:
        self.action_feedback = tibi_dabo_msgs.msg.guideGoalActionFeedback()
    else:
      self.action_goal = tibi_dabo_msgs.msg.guideGoalActionGoal()
      self.action_result = tibi_dabo_msgs.msg.guideGoalActionResult()
      self.action_feedback = tibi_dabo_msgs.msg.guideGoalActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7di3I.pack(_x.action_goal.goal.target_pose.pose.position.x, _x.action_goal.goal.target_pose.pose.position.y, _x.action_goal.goal.target_pose.pose.position.z, _x.action_goal.goal.target_pose.pose.orientation.x, _x.action_goal.goal.target_pose.pose.orientation.y, _x.action_goal.goal.target_pose.pose.orientation.z, _x.action_goal.goal.target_pose.pose.orientation.w, _x.action_goal.goal.target_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_result.result.result_code))
      _x = self.action_result.result.result_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_result.result.result_code,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.result_type = str[start:end].decode('utf-8')
      else:
        self.action_result.result.result_type = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.distance,) = _struct_f.unpack(str[start:end])
      return self
