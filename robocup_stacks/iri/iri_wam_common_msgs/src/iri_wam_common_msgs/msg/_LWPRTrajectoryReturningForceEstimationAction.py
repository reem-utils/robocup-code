"""autogenerated by genpy from iri_wam_common_msgs/LWPRTrajectoryReturningForceEstimationAction.msg. Do not edit."""
import sys
...
class LWPRTrajectoryReturningForceEstimationAction(genpy.Message):
  _md5sum = "0592c1ed5f73ef46d87caf22ed58f5eb"
  _type = "iri_wam_common_msgs/LWPRTrajectoryReturningForceEstimationAction"
...
"""
  ...
  _slot_types = ['iri_wam_common_msgs/LWPRTrajectoryReturningForceEstimationActionGoal','iri_wam_common_msgs/LWPRTrajectoryReturningForceEstimationActionResult','iri_wam_common_msgs/LWPRTrajectoryReturningForceEstimationActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LWPRTrajectoryReturningForceEstimationAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = iri_wam_common_msgs.msg.LWPRTrajectoryReturningForceEstimationActionGoal()
      if self.action_result is None:
        self.action_result = iri_wam_common_msgs.msg.LWPRTrajectoryReturningForceEstimationActionResult()
      if self.action_feedback is None:
        self.action_feedback = iri_wam_common_msgs.msg.LWPRTrajectoryReturningForceEstimationActionFeedback()
    else:
      self.action_goal = iri_wam_common_msgs.msg.LWPRTrajectoryReturningForceEstimationActionGoal()
      self.action_result = iri_wam_common_msgs.msg.LWPRTrajectoryReturningForceEstimationActionResult()
      self.action_feedback = iri_wam_common_msgs.msg.LWPRTrajectoryReturningForceEstimationActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.model_filename
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.points_filename
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_result.result.force, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.model_filename = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.model_filename = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.points_filename = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.points_filename = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.force, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
