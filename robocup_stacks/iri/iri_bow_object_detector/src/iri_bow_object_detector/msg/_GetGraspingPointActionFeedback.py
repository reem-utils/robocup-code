"""autogenerated by genpy from iri_bow_object_detector/GetGraspingPointActionFeedback.msg. Do not edit."""
import sys
...
class GetGraspingPointActionFeedback(genpy.Message):
  _md5sum = "25bfb21ced59f4f9490772d56f6961f4"
  _type = "iri_bow_object_detector/GetGraspingPointActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iri_bow_object_detector/GetGraspingPointFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetGraspingPointActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = iri_bow_object_detector.msg.GetGraspingPointFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = iri_bow_object_detector.msg.GetGraspingPointFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.percent_complete,) = _struct_f.unpack(str[start:end])
      return self
