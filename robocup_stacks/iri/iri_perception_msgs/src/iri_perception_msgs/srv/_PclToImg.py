"""autogenerated by genpy from iri_perception_msgs/PclToImgRequest.msg. Do not edit."""
import sys
...
class PclToImgRequest(genpy.Message):
  _md5sum = "56680b720436a8fbd002ea7abe6966e1"
  _type = "iri_perception_msgs/PclToImgRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PclToImgRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from iri_perception_msgs/PclToImgResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PclToImgResponse(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "iri_perception_msgs/PclToImgResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PclToImgResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class PclToImg(object):
  _type          = 'iri_perception_msgs/PclToImg'
  _md5sum = '1036a14b8c4c20601506406b1e3a4ca1'
  _request_class  = PclToImgRequest
  _response_class = PclToImgResponse
