"""autogenerated by genpy from iri_perception_msgs/peopleTrackActionFeedback.msg. Do not edit."""
import sys
...
class peopleTrackActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "iri_perception_msgs/peopleTrackActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iri_perception_msgs/peopleTrackFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(peopleTrackActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = iri_perception_msgs.msg.peopleTrackFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = iri_perception_msgs.msg.peopleTrackFeedback()
