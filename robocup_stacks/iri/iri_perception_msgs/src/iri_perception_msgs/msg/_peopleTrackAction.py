"""autogenerated by genpy from iri_perception_msgs/peopleTrackAction.msg. Do not edit."""
import sys
...
class peopleTrackAction(genpy.Message):
  _md5sum = "5298736c3ca78ba472cc45ad505b6b38"
  _type = "iri_perception_msgs/peopleTrackAction"
...
"""
  ...
  _slot_types = ['iri_perception_msgs/peopleTrackActionGoal','iri_perception_msgs/peopleTrackActionResult','iri_perception_msgs/peopleTrackActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(peopleTrackAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = iri_perception_msgs.msg.peopleTrackActionGoal()
      if self.action_result is None:
        self.action_result = iri_perception_msgs.msg.peopleTrackActionResult()
      if self.action_feedback is None:
        self.action_feedback = iri_perception_msgs.msg.peopleTrackActionFeedback()
    else:
      self.action_goal = iri_perception_msgs.msg.peopleTrackActionGoal()
      self.action_result = iri_perception_msgs.msg.peopleTrackActionResult()
      self.action_feedback = iri_perception_msgs.msg.peopleTrackActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.ps.header.seq, _x.action_result.result.ps.header.stamp.secs, _x.action_result.result.ps.header.stamp.nsecs))
      _x = self.action_result.result.ps.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.ps.peopleSet)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.ps.peopleSet:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.ps.header.seq, _x.action_result.result.ps.header.stamp.secs, _x.action_result.result.ps.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.ps.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.ps.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.ps.peopleSet = []
      for i in range(0, length):
        ...
        self.action_result.result.ps.peopleSet.append(val1)
      _x = self
      start = end
      end += 12
