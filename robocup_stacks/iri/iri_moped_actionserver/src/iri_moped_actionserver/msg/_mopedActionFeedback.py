"""autogenerated by genpy from iri_moped_actionserver/mopedActionFeedback.msg. Do not edit."""
import sys
...
class mopedActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "iri_moped_actionserver/mopedActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iri_moped_actionserver/mopedFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mopedActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = iri_moped_actionserver.msg.mopedFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = iri_moped_actionserver.msg.mopedFeedback()
