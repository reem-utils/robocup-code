...
#ifndef _moped_actionserver_alg_node_h_
#define _moped_actionserver_alg_node_h_
 ...
 *
 */
class MopedActionserverAlgNode : public algorithm_base::IriBaseAlgorithm<MopedActionserverAlgorithm>
{
  private:
