"""autogenerated by genpy from estirabot_msgs/GraspVerification.msg. Do not edit."""
import sys
...
class GraspVerification(genpy.Message):
  _md5sum = "e3d204a43e7cce62c1853351b215f13e"
  _type = "estirabot_msgs/GraspVerification"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Message containing results from a sequence of verification actions on a grasAFTER_SHAKING = 1p
...
"""
  ...
  __slots__ = ['grasp_results','grasp_images']
  _slot_types = ['object_manipulation_msgs/GraspResult[]','sensor_msgs/PointCloud2[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspVerification, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.grasp_results is None:
        self.grasp_results = []
      if self.grasp_images is None:
        self.grasp_images = []
    else:
      self.grasp_results = []
      self.grasp_images = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.grasp_results)
      buff.write(_struct_I.pack(length))
      for val1 in self.grasp_results:
        _x = val1
        buff.write(_struct_iB.pack(_x.result_code, _x.continuation_possible))
      length = len(self.grasp_images)
      buff.write(_struct_I.pack(length))
      for val1 in self.grasp_images:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      if self.grasp_results is None:
        self.grasp_results = None
      if self.grasp_images is None:
        self.grasp_images = None
      end = 0
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.grasp_results.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.grasp_images = []
