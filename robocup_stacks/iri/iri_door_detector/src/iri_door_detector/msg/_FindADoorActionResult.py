"""autogenerated by genpy from iri_door_detector/FindADoorActionResult.msg. Do not edit."""
import sys
...
class FindADoorActionResult(genpy.Message):
  _md5sum = "6cc5ec3da569ede50554339713683f58"
  _type = "iri_door_detector/FindADoorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','iri_door_detector/FindADoorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindADoorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = iri_door_detector.msg.FindADoorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = iri_door_detector.msg.FindADoorResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.result.base_poses.header.seq, _x.result.base_poses.header.stamp.secs, _x.result.base_poses.header.stamp.nsecs))
      _x = self.result.base_poses.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      length = len(self.result.arm_poses.workspace_parameters.workspace_region_shape.dimensions)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.arm_poses.workspace_parameters.workspace_region_shape.dimensions))
      length = len(self.result.arm_poses.workspace_parameters.workspace_region_shape.triangles)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.result.arm_poses.workspace_parameters.workspace_region_shape.triangles))
      length = len(self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices:
        _x = val1
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_struct_3I.pack(_x.result.arm_poses.workspace_parameters.workspace_region_pose.header.seq, _x.result.arm_poses.workspace_parameters.workspace_region_pose.header.stamp.secs, _x.result.arm_poses.workspace_parameters.workspace_region_pose.header.stamp.nsecs))
      _x = self.result.arm_poses.workspace_parameters.workspace_region_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.result.arm_poses.start_state.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.arm_poses.start_state.joint_state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.start_state.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.result.arm_poses.start_state.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.arm_poses.start_state.joint_state.position))
      length = len(self.result.arm_poses.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.arm_poses.start_state.joint_state.velocity))
      length = len(self.result.arm_poses.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.arm_poses.start_state.joint_state.effort))
      _x = self
      buff.write(_struct_2I.pack(_x.result.arm_poses.start_state.multi_dof_joint_state.stamp.secs, _x.result.arm_poses.start_state.multi_dof_joint_state.stamp.nsecs))
      length = len(self.result.arm_poses.start_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.start_state.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.result.arm_poses.start_state.multi_dof_joint_state.frame_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.start_state.multi_dof_joint_state.frame_ids:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.result.arm_poses.start_state.multi_dof_joint_state.child_frame_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.start_state.multi_dof_joint_state.child_frame_ids:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.result.arm_poses.start_state.multi_dof_joint_state.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.start_state.multi_dof_joint_state.poses:
        _v1 = val1.position
        _x = _v1
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      ...
      length = len(self.result.arm_poses.goal_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.goal_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.result.arm_poses.goal_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.goal_constraints.position_constraints:
        _v3 = val1.header
      ...
      length = len(self.result.arm_poses.goal_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.goal_constraints.orientation_constraints:
        _v9 = val1.header
      ...
      length = len(self.result.arm_poses.goal_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.goal_constraints.visibility_constraints:
        _v12 = val1.header
      ...
      length = len(self.result.arm_poses.path_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.path_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1
        buff.write(_struct_4d.pack(_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight))
      length = len(self.result.arm_poses.path_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.path_constraints.position_constraints:
        _v24 = val1.header
        ...
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_d.pack(val1.weight))
      length = len(self.result.arm_poses.path_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.path_constraints.orientation_constraints:
        _v30 = val1.header
        ...
        _x = val1
        buff.write(_struct_4d.pack(_x.absolute_roll_tolerance, _x.absolute_pitch_tolerance, _x.absolute_yaw_tolerance, _x.weight))
      length = len(self.result.arm_poses.path_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.path_constraints.visibility_constraints:
        _v33 = val1.header
        ...
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_d.pack(val1.absolute_tolerance))
      _x = self.result.arm_poses.planner_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.result.arm_poses.group_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.base_poses.header.seq, _x.result.base_poses.header.stamp.secs, _x.result.base_poses.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.base_poses.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.base_poses.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 57
      ...
      self.result.arm_poses.workspace_parameters.workspace_region_shape.dimensions = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.result.arm_poses.workspace_parameters.workspace_region_shape.triangles = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices = []
      for i in range(0, length):
        ...
        self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices.append(val1)
      _x = self
      start = end
      end += 12
      (_x.result.arm_poses.workspace_parameters.workspace_region_pose.header.seq, _x.result.arm_poses.workspace_parameters.workspace_region_pose.header.stamp.secs, _x.result.arm_poses.workspace_parameters.workspace_region_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.arm_poses.workspace_parameters.workspace_region_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.arm_poses.workspace_parameters.workspace_region_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      ...
      if python3:
        self.result.arm_poses.start_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.result.arm_poses.start_state.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.start_state.joint_state.name = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.arm_poses.start_state.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.result.arm_poses.start_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.result.arm_poses.start_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.result.arm_poses.start_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 8
      (_x.result.arm_poses.start_state.multi_dof_joint_state.stamp.secs, _x.result.arm_poses.start_state.multi_dof_joint_state.stamp.nsecs,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.start_state.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.arm_poses.start_state.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.start_state.multi_dof_joint_state.frame_ids = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.arm_poses.start_state.multi_dof_joint_state.frame_ids.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.start_state.multi_dof_joint_state.child_frame_ids = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.arm_poses.start_state.multi_dof_joint_state.child_frame_ids.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.start_state.multi_dof_joint_state.poses = []
      for i in range(0, length):
        ...
        self.result.arm_poses.start_state.multi_dof_joint_state.poses.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.goal_constraints.joint_constraints = []
      for i in range(0, length):
        ...
        self.result.arm_poses.goal_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.goal_constraints.position_constraints = []
      for i in range(0, length):
        ...
        self.result.arm_poses.goal_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.goal_constraints.orientation_constraints = []
      for i in range(0, length):
        ...
        self.result.arm_poses.goal_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.goal_constraints.visibility_constraints = []
      for i in range(0, length):
        ...
        self.result.arm_poses.goal_constraints.visibility_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.path_constraints.joint_constraints = []
      for i in range(0, length):
        val1 = arm_navigation_msgs.msg.JointConstraint()
        start = end
        end += 4
        ...
        (_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight,) = _struct_4d.unpack(str[start:end])
        self.result.arm_poses.path_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.path_constraints.position_constraints = []
      for i in range(0, length):
        val1 = arm_navigation_msgs.msg.PositionConstraint()
        _v68 = val1.header
        start = end
        ...
        (val1.weight,) = _struct_d.unpack(str[start:end])
        self.result.arm_poses.path_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.path_constraints.orientation_constraints = []
      for i in range(0, length):
        val1 = arm_navigation_msgs.msg.OrientationConstraint()
        _v74 = val1.header
        start = end
        ...
        (_x.absolute_roll_tolerance, _x.absolute_pitch_tolerance, _x.absolute_yaw_tolerance, _x.weight,) = _struct_4d.unpack(str[start:end])
        self.result.arm_poses.path_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.path_constraints.visibility_constraints = []
      for i in range(0, length):
        val1 = arm_navigation_msgs.msg.VisibilityConstraint()
        _v77 = val1.header
        start = end
        ...
        (val1.absolute_tolerance,) = _struct_d.unpack(str[start:end])
        self.result.arm_poses.path_constraints.visibility_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.arm_poses.planner_id = str[start:end].decode('utf-8')
      else:
        self.result.arm_poses.planner_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.arm_poses.group_name = str[start:end].decode('utf-8')
      else:
        self.result.arm_poses.group_name = str[start:end]
      _x = self
      start = end
      end += 28
      ...
      if python3:
        self.result.planner_service_name = str[start:end].decode('utf-8')
      else:
        self.result.planner_service_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.state = str[start:end].decode('utf-8')
      else:
        self.result.state = str[start:end]
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.result.arm_poses.workspace_parameters.workspace_region_shape.dimensions.tostring())
      length = len(self.result.arm_poses.workspace_parameters.workspace_region_shape.triangles)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.result.arm_poses.workspace_parameters.workspace_region_shape.triangles.tostring())
      length = len(self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices:
        _x = val1
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.result.arm_poses.start_state.joint_state.position.tostring())
      length = len(self.result.arm_poses.start_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.result.arm_poses.start_state.joint_state.velocity.tostring())
      length = len(self.result.arm_poses.start_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.result.arm_poses.start_state.joint_state.effort.tostring())
      _x = self
      buff.write(_struct_2I.pack(_x.result.arm_poses.start_state.multi_dof_joint_state.stamp.secs, _x.result.arm_poses.start_state.multi_dof_joint_state.stamp.nsecs))
      length = len(self.result.arm_poses.start_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.result.arm_poses.workspace_parameters.workspace_region_shape.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.result.arm_poses.workspace_parameters.workspace_region_shape.triangles = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.arm_poses.workspace_parameters.workspace_region_shape.vertices = []
      ...
      self.result.arm_poses.start_state.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.result.arm_poses.start_state.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.result.arm_poses.start_state.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 8
      (_x.result.arm_poses.start_state.multi_dof_joint_state.stamp.secs, _x.result.arm_poses.start_state.multi_dof_joint_state.stamp.nsecs,) = _struct_2I.unpack(str[start:end])
