"""autogenerated by genpy from iri_sift/DescriptorsFromImageRequest.msg. Do not edit."""
import sys
...
class DescriptorsFromImageRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "iri_sift/DescriptorsFromImageRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DescriptorsFromImageRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from iri_sift/DescriptorsFromImageResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class DescriptorsFromImageResponse(genpy.Message):
  _md5sum = "db5e12e66d3b02ca867728f150b58d69"
  _type = "iri_sift/DescriptorsFromImageResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DescriptorsFromImageResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class DescriptorsFromImage(object):
  _type          = 'iri_sift/DescriptorsFromImage'
  _md5sum = '3f84e2bbe8799c8c0db43a5ff96da0c4'
  _request_class  = DescriptorsFromImageRequest
  _response_class = DescriptorsFromImageResponse
