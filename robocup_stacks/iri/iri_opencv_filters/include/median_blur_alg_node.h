...
#ifndef _median_blur_alg_node_h_
#define _median_blur_alg_node_h_
 ...
 *
 */
class MedianBlurAlgNode : public algorithm_base::IriBaseAlgorithm<MedianBlurAlgorithm>
{
  private:
