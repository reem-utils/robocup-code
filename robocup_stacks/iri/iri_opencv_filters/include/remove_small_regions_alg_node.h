...
#ifndef _remove_small_regions_alg_node_h_
#define _remove_small_regions_alg_node_h_
 ...
 *
 */
class RemoveSmallRegionsAlgNode : public algorithm_base::IriBaseAlgorithm<RemoveSmallRegionsAlgorithm>
{
  private:
