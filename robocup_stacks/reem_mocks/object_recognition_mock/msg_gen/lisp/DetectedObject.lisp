...
(cl:defclass <DetectedObject> (roslisp-msg-protocol:ros-message)
  ((points2d
    :reader points2d
    :initarg :points2d
    :type (cl:vector object_recognition_mock-msg:Pixel)
   :initform (cl:make-array 0 :element-type 'object_recognition_mock-msg:Pixel :initial-element (cl:make-instance 'object_recognition_mock-msg:Pixel)))
   (points3d
    :reader points3d
    :initarg :points3d
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_recognition_mock-msg:<DetectedObject> is deprecated: use object_recognition_mock-msg:DetectedObject instead.")))

(cl:ensure-generic-function 'points2d-val :lambda-list '(m))
(cl:defmethod points2d-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:points2d-val is deprecated.  Use object_recognition_mock-msg:points2d instead.")
  (points2d m))

(cl:ensure-generic-function 'points3d-val :lambda-list '(m))
(cl:defmethod points3d-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:points3d-val is deprecated.  Use object_recognition_mock-msg:points3d instead.")
  (points3d m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:pose-val is deprecated.  Use object_recognition_mock-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'points3d_model-val :lambda-list '(m))
(cl:defmethod points3d_model-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:points3d_model-val is deprecated.  Use object_recognition_mock-msg:points3d_model instead.")
  (points3d_model m))

(cl:ensure-generic-function 'octave-val :lambda-list '(m))
(cl:defmethod octave-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:octave-val is deprecated.  Use object_recognition_mock-msg:octave instead.")
  (octave m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObject>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points2d)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_recognition_mock-msg:Pixel))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObject>)))
  ...
  "object_recognition_mock/DetectedObject")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObject)))
  "Returns string type for a message object of type 'DetectedObject"
  "object_recognition_mock/DetectedObject")
