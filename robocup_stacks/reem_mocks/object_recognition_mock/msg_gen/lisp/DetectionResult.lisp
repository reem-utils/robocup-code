...
(cl:in-package object_recognition_mock-msg)
...
(cl:defclass <DetectionResult> (roslisp-msg-protocol:ros-message)
  ((Image
   ...
   (Detections
    :reader Detections
    :initarg :Detections
    :type (cl:vector object_recognition_mock-msg:DetectedObject)
   :initform (cl:make-array 0 :element-type 'object_recognition_mock-msg:DetectedObject :initial-element (cl:make-instance 'object_recognition_mock-msg:DetectedObject))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_recognition_mock-msg:<DetectionResult> is deprecated: use object_recognition_mock-msg:DetectionResult instead.")))

(cl:ensure-generic-function 'Image-val :lambda-list '(m))
(cl:defmethod Image-val ((m <DetectionResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:Image-val is deprecated.  Use object_recognition_mock-msg:Image instead.")
  (Image m))

(cl:ensure-generic-function 'ObjectNames-val :lambda-list '(m))
(cl:defmethod ObjectNames-val ((m <DetectionResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:ObjectNames-val is deprecated.  Use object_recognition_mock-msg:ObjectNames instead.")
  (ObjectNames m))

(cl:ensure-generic-function 'Detections-val :lambda-list '(m))
(cl:defmethod Detections-val ((m <DetectionResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:Detections-val is deprecated.  Use object_recognition_mock-msg:Detections instead.")
  (Detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectionResult>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'Detections)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_recognition_mock-msg:DetectedObject))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectionResult>)))
  ...
  "object_recognition_mock/DetectionResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectionResult)))
  "Returns string type for a message object of type 'DetectionResult"
  "object_recognition_mock/DetectionResult")
