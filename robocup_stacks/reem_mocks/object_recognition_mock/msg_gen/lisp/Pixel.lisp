...
(cl:defmethod cl:initialize-instance :after ((m <Pixel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pixel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_recognition_mock-msg:<Pixel> is deprecated: use object_recognition_mock-msg:Pixel instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pixel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:x-val is deprecated.  Use object_recognition_mock-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pixel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_recognition_mock-msg:y-val is deprecated.  Use object_recognition_mock-msg:y instead.")
  (y m))
