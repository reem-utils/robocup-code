"""autogenerated by genpy from object_recognition_mock/DetectionResult.msg. Do not edit."""
import sys
...
class DetectionResult(genpy.Message):
  ...
  _type = "object_recognition_mock/DetectionResult"
...
"""
  ...
  _slot_types = ['sensor_msgs/Image','string[]','object_recognition_mock/DetectedObject[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.Detections = []
      for i in range(0, length):
        val1 = object_recognition_mock.msg.DetectedObject()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.points2d = []
        for i in range(0, length):
          val2 = object_recognition_mock.msg.Pixel()
          _x = val2
          start = end
          end += 8
