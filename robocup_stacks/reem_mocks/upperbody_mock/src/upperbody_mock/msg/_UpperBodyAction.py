"""autogenerated by genpy from upperbody_mock/UpperBodyAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import upperbody_mock.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class UpperBodyAction(genpy.Message):
  _md5sum = "3d0c87e03a9955caee5d82b882ca257d"
  _type = "upperbody_mock/UpperBodyAction"
...
"""
  ...
  _slot_types = ['upperbody_mock/UpperBodyActionGoal','upperbody_mock/UpperBodyActionResult','upperbody_mock/UpperBodyActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UpperBodyAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbody_mock.msg.UpperBodyActionGoal()
      if self.action_result is None:
        self.action_result = upperbody_mock.msg.UpperBodyActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbody_mock.msg.UpperBodyActionFeedback()
    else:
      self.action_goal = upperbody_mock.msg.UpperBodyActionGoal()
      self.action_result = upperbody_mock.msg.UpperBodyActionResult()
      self.action_feedback = upperbody_mock.msg.UpperBodyActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.motion_file
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_goal.goal.validate_trajectory, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.motion_file = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.motion_file = str[start:end]
      _x = self
      start = end
      end += 13
      (_x.action_goal.goal.validate_trajectory, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_goal.goal.validate_trajectory = bool(self.action_goal.goal.validate_trajectory)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
