"""autogenerated by genpy from upperbody_mock/UpperBodyActionResult.msg. Do not edit."""
import sys
...
class UpperBodyActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "upperbody_mock/UpperBodyActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','upperbody_mock/UpperBodyResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UpperBodyActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = upperbody_mock.msg.UpperBodyResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = upperbody_mock.msg.UpperBodyResult()
