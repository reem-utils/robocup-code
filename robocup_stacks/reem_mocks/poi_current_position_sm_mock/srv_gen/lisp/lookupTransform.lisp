...
(cl:in-package poi_current_position_sm_mock-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <lookupTransform-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lookupTransform-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name poi_current_position_sm_mock-srv:<lookupTransform-request> is deprecated: use poi_current_position_sm_mock-srv:lookupTransform-request instead.")))

(cl:ensure-generic-function 'target_frame-val :lambda-list '(m))
(cl:defmethod target_frame-val ((m <lookupTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader poi_current_position_sm_mock-srv:target_frame-val is deprecated.  Use poi_current_position_sm_mock-srv:target_frame instead.")
  (target_frame m))

(cl:ensure-generic-function 'source_frame-val :lambda-list '(m))
(cl:defmethod source_frame-val ((m <lookupTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader poi_current_position_sm_mock-srv:source_frame-val is deprecated.  Use poi_current_position_sm_mock-srv:source_frame instead.")
  (source_frame m))

(cl:ensure-generic-function 'transform_time-val :lambda-list '(m))
(cl:defmethod transform_time-val ((m <lookupTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader poi_current_position_sm_mock-srv:transform_time-val is deprecated.  Use poi_current_position_sm_mock-srv:transform_time instead.")
  (transform_time m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lookupTransform-request>)))
  ...
  "poi_current_position_sm_mock/lookupTransformRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lookupTransform-request)))
  "Returns string type for a service object of type 'lookupTransform-request"
  "poi_current_position_sm_mock/lookupTransformRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lookupTransform-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lookupTransform-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name poi_current_position_sm_mock-srv:<lookupTransform-response> is deprecated: use poi_current_position_sm_mock-srv:lookupTransform-response instead.")))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <lookupTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader poi_current_position_sm_mock-srv:transform-val is deprecated.  Use poi_current_position_sm_mock-srv:transform instead.")
  (transform m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lookupTransform-response>)))
  ...
  "poi_current_position_sm_mock/lookupTransformResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lookupTransform-response)))
  "Returns string type for a service object of type 'lookupTransform-response"
  "poi_current_position_sm_mock/lookupTransformResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lookupTransform)))
  ...
  "poi_current_position_sm_mock/lookupTransform")