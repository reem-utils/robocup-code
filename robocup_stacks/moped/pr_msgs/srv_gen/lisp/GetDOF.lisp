...
(cl:defmethod cl:initialize-instance :after ((m <GetDOF-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDOF-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<GetDOF-request> is deprecated: use pr_msgs-srv:GetDOF-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetDOF-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDOF-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<GetDOF-response> is deprecated: use pr_msgs-srv:GetDOF-response instead.")))

(cl:ensure-generic-function 'nDOF-val :lambda-list '(m))
(cl:defmethod nDOF-val ((m <GetDOF-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:nDOF-val is deprecated.  Use pr_msgs-srv:nDOF instead.")
  (nDOF m))
