...
(cl:defclass <SetGains-request> (roslisp-msg-protocol:ros-message)
  ((joint
   ...
   (gains
    :reader gains
    :initarg :gains
    :type pr_msgs-msg:PIDgains
    :initform (cl:make-instance 'pr_msgs-msg:PIDgains)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetGains-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGains-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetGains-request> is deprecated: use pr_msgs-srv:SetGains-request instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <SetGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:joint-val is deprecated.  Use pr_msgs-srv:joint instead.")
  (joint m))

(cl:ensure-generic-function 'gains-val :lambda-list '(m))
(cl:defmethod gains-val ((m <SetGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:gains-val is deprecated.  Use pr_msgs-srv:gains instead.")
  (gains m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetGains-request>)))
  ...
  (cl:format cl:nil "uint8 joint~%pr_msgs/PIDgains gains~%~%================================================================================~%MSG: pr_msgs/PIDgains~%float64 kp~%float64 kd~%float64 ki~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetGains-request)))
  "Returns full string definition for message of type 'SetGains-request"
  (cl:format cl:nil "uint8 joint~%pr_msgs/PIDgains gains~%~%================================================================================~%MSG: pr_msgs/PIDgains~%float64 kp~%float64 kd~%float64 ki~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetGains-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGains-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetGains-response> is deprecated: use pr_msgs-srv:SetGains-response instead.")))
