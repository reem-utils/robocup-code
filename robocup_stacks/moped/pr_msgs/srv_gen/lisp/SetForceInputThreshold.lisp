...
(cl:defmethod cl:initialize-instance :after ((m <SetForceInputThreshold-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetForceInputThreshold-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetForceInputThreshold-request> is deprecated: use pr_msgs-srv:SetForceInputThreshold-request instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <SetForceInputThreshold-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:direction-val is deprecated.  Use pr_msgs-srv:direction instead.")
  (direction m))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <SetForceInputThreshold-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:force-val is deprecated.  Use pr_msgs-srv:force instead.")
  (force m))

(cl:ensure-generic-function 'torques-val :lambda-list '(m))
(cl:defmethod torques-val ((m <SetForceInputThreshold-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:torques-val is deprecated.  Use pr_msgs-srv:torques instead.")
  (torques m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetForceInputThreshold-request>)))
  ...
  "pr_msgs/SetForceInputThresholdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetForceInputThreshold-request)))
  "Returns string type for a service object of type 'SetForceInputThreshold-request"
  "pr_msgs/SetForceInputThresholdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetForceInputThreshold-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetForceInputThreshold-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetForceInputThreshold-response> is deprecated: use pr_msgs-srv:SetForceInputThreshold-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetForceInputThreshold-response>)))
  ...
  "pr_msgs/SetForceInputThresholdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetForceInputThreshold-response)))
  "Returns string type for a service object of type 'SetForceInputThreshold-response"
  "pr_msgs/SetForceInputThresholdResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetForceInputThreshold)))
  ...
  "pr_msgs/SetForceInputThreshold")