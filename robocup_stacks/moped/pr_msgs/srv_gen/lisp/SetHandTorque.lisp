...
(cl:defmethod cl:initialize-instance :after ((m <SetHandTorque-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHandTorque-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetHandTorque-request> is deprecated: use pr_msgs-srv:SetHandTorque-request instead.")))

(cl:ensure-generic-function 'initial-val :lambda-list '(m))
(cl:defmethod initial-val ((m <SetHandTorque-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:initial-val is deprecated.  Use pr_msgs-srv:initial instead.")
  (initial m))

(cl:ensure-generic-function 'sustained-val :lambda-list '(m))
(cl:defmethod sustained-val ((m <SetHandTorque-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:sustained-val is deprecated.  Use pr_msgs-srv:sustained instead.")
  (sustained m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetHandTorque-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHandTorque-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetHandTorque-response> is deprecated: use pr_msgs-srv:SetHandTorque-response instead.")))
