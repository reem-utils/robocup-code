...
(cl:defclass <SetExtraMass-request> (roslisp-msg-protocol:ros-message)
  ((m
    :reader m
    :initarg :m
    :type pr_msgs-msg:MassProperties
    :initform (cl:make-instance 'pr_msgs-msg:MassProperties)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetExtraMass-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetExtraMass-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetExtraMass-request> is deprecated: use pr_msgs-srv:SetExtraMass-request instead.")))

(cl:ensure-generic-function 'm-val :lambda-list '(m))
(cl:defmethod m-val ((m <SetExtraMass-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:m-val is deprecated.  Use pr_msgs-srv:m instead.")
  (m m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetExtraMass-request>)))
  ...
  (cl:format cl:nil "pr_msgs/MassProperties m~%~%================================================================================~%MSG: pr_msgs/MassProperties~%uint8 link~%float64 mass~%float64 cog_x~%float64 cog_y~%float64 cog_z~%float64 inertia_xx~%float64 inertia_xy~%float64 inertia_xz~%float64 inertia_yy~%float64 inertia_yz~%float64 inertia_zz~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetExtraMass-request)))
  "Returns full string definition for message of type 'SetExtraMass-request"
  (cl:format cl:nil "pr_msgs/MassProperties m~%~%================================================================================~%MSG: pr_msgs/MassProperties~%uint8 link~%float64 mass~%float64 cog_x~%float64 cog_y~%float64 cog_z~%float64 inertia_xx~%float64 inertia_xy~%float64 inertia_xz~%float64 inertia_yy~%float64 inertia_yz~%float64 inertia_zz~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetExtraMass-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetExtraMass-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetExtraMass-response> is deprecated: use pr_msgs-srv:SetExtraMass-response instead.")))
