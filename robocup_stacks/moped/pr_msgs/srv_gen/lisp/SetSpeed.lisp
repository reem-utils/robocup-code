...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetSpeed-request> is deprecated: use pr_msgs-srv:SetSpeed-request instead.")))

(cl:ensure-generic-function 'velocities-val :lambda-list '(m))
(cl:defmethod velocities-val ((m <SetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:velocities-val is deprecated.  Use pr_msgs-srv:velocities instead.")
  (velocities m))

(cl:ensure-generic-function 'min_accel_time-val :lambda-list '(m))
(cl:defmethod min_accel_time-val ((m <SetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:min_accel_time-val is deprecated.  Use pr_msgs-srv:min_accel_time instead.")
  (min_accel_time m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetSpeed-response> is deprecated: use pr_msgs-srv:SetSpeed-response instead.")))
