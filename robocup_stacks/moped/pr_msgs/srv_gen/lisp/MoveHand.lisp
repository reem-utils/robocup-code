...
(cl:defmethod cl:initialize-instance :after ((m <MoveHand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveHand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<MoveHand-request> is deprecated: use pr_msgs-srv:MoveHand-request instead.")))

(cl:ensure-generic-function 'movetype-val :lambda-list '(m))
(cl:defmethod movetype-val ((m <MoveHand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:movetype-val is deprecated.  Use pr_msgs-srv:movetype instead.")
  (movetype m))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveHand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveHand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<MoveHand-response> is deprecated: use pr_msgs-srv:MoveHand-response instead.")))
