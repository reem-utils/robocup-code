...
(cl:defmethod cl:initialize-instance :after ((m <SetHandProperty-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHandProperty-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetHandProperty-request> is deprecated: use pr_msgs-srv:SetHandProperty-request instead.")))

(cl:ensure-generic-function 'nodeid-val :lambda-list '(m))
(cl:defmethod nodeid-val ((m <SetHandProperty-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:nodeid-val is deprecated.  Use pr_msgs-srv:nodeid instead.")
  (nodeid m))

(cl:ensure-generic-function 'property-val :lambda-list '(m))
(cl:defmethod property-val ((m <SetHandProperty-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:property-val is deprecated.  Use pr_msgs-srv:property instead.")
  (property m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SetHandProperty-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:value-val is deprecated.  Use pr_msgs-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetHandProperty-request>)))
  ...
  "pr_msgs/SetHandPropertyRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetHandProperty-request)))
  "Returns string type for a service object of type 'SetHandProperty-request"
  "pr_msgs/SetHandPropertyRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetHandProperty-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHandProperty-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetHandProperty-response> is deprecated: use pr_msgs-srv:SetHandProperty-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetHandProperty-response>)))
  ...
  "pr_msgs/SetHandPropertyResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetHandProperty-response)))
  "Returns string type for a service object of type 'SetHandProperty-response"
  "pr_msgs/SetHandPropertyResponse")
