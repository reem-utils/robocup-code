...
(cl:defmethod cl:initialize-instance :after ((m <RelaxHand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RelaxHand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<RelaxHand-request> is deprecated: use pr_msgs-srv:RelaxHand-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <RelaxHand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RelaxHand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<RelaxHand-response> is deprecated: use pr_msgs-srv:RelaxHand-response instead.")))
