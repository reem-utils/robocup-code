...
(cl:defmethod cl:initialize-instance :after ((m <ResetFinger-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetFinger-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<ResetFinger-request> is deprecated: use pr_msgs-srv:ResetFinger-request instead.")))

(cl:ensure-generic-function 'finger-val :lambda-list '(m))
(cl:defmethod finger-val ((m <ResetFinger-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:finger-val is deprecated.  Use pr_msgs-srv:finger instead.")
  (finger m))
...
(cl:defmethod cl:initialize-instance :after ((m <ResetFinger-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetFinger-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<ResetFinger-response> is deprecated: use pr_msgs-srv:ResetFinger-response instead.")))
