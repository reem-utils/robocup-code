...
(cl:defmethod cl:initialize-instance :after ((m <SetStiffness-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetStiffness-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetStiffness-request> is deprecated: use pr_msgs-srv:SetStiffness-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetStiffness-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetStiffness-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<SetStiffness-response> is deprecated: use pr_msgs-srv:SetStiffness-response instead.")))
