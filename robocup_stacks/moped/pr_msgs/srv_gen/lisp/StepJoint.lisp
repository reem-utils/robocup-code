...
(cl:defmethod cl:initialize-instance :after ((m <StepJoint-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepJoint-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<StepJoint-request> is deprecated: use pr_msgs-srv:StepJoint-request instead.")))
...
(cl:defmethod radians-val ((m <StepJoint-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-srv:radians-val is deprecated.  Use pr_msgs-srv:radians instead.")
  (radians m))
...
(cl:defmethod cl:initialize-instance :after ((m <StepJoint-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepJoint-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<StepJoint-response> is deprecated: use pr_msgs-srv:StepJoint-response instead.")))
