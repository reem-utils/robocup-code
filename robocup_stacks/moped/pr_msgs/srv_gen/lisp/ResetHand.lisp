...
(cl:defmethod cl:initialize-instance :after ((m <ResetHand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetHand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<ResetHand-request> is deprecated: use pr_msgs-srv:ResetHand-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ResetHand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetHand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-srv:<ResetHand-response> is deprecated: use pr_msgs-srv:ResetHand-response instead.")))
