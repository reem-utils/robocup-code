/* Auto-generated by genmsg_cpp for file /home/sampfeiffer/branches_svn/migration/ROBOCUP_STACKS_INTEGRATION/stacks/robocup_stacks/moped/pr_msgs/srv/SetSpeed.srv */
#ifndef PR_MSGS_SERVICE_SETSPEED_H
#define PR_MSGS_SERVICE_SETSPEED_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct SetSpeedResponse_ {
  ...
  typedef boost::shared_ptr< ::pr_msgs::SetSpeedResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::pr_msgs::SetSpeedResponse_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct SetSpeedResponse
typedef  ::pr_msgs::SetSpeedResponse_<std::allocator<void> > SetSpeedResponse;

typedef boost::shared_ptr< ::pr_msgs::SetSpeedResponse> SetSpeedResponsePtr;
typedef boost::shared_ptr< ::pr_msgs::SetSpeedResponse const> SetSpeedResponseConstPtr;
...
{
template<class ContainerAllocator> struct IsMessage< ::pr_msgs::SetSpeedRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::pr_msgs::SetSpeedRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::pr_msgs::SetSpeedResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::pr_msgs::SetSpeedResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::pr_msgs::SetSpeedResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "4679398f882e7cbdea165980d3ec2888";
  }

  static const char* value(const  ::pr_msgs::SetSpeedResponse_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x4679398f882e7cbdULL;
  static const uint64_t static_value2 = 0xea165980d3ec2888ULL;
};

template<class ContainerAllocator>
struct DataType< ::pr_msgs::SetSpeedResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "pr_msgs/SetSpeedResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::pr_msgs::SetSpeedResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "bool ok\n\
string reason\n\
...
template<class ContainerAllocator> struct Serializer< ::pr_msgs::SetSpeedResponse_<ContainerAllocator> >
{
  template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
  {
    stream.next(m.ok);
...
{
template<>
struct MD5Sum<pr_msgs::SetSpeed> {
  static const char* value() 
  {
    return "98432a87a24b80d916ec91158921504f";
  }

  static const char* value(const pr_msgs::SetSpeed&) { return value(); } 
};

template<>
struct DataType<pr_msgs::SetSpeed> {
  static const char* value() 
  {
    return "pr_msgs/SetSpeed";
  }
...
#endif // PR_MSGS_SERVICE_SETSPEED_H
