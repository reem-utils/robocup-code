"""autogenerated by genpy from pr_msgs/BHState.msg. Do not edit."""
import sys
...
class BHState(genpy.Message):
  _md5sum = "e6b6dfb306cd8c934654e8dd288b25fb"
  _type = "pr_msgs/BHState"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.internal_state = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.puck_mode = str[start:end].decode('utf-8')
      else:
