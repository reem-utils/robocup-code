"""autogenerated by genpy from pr_msgs/SignalActionFeedback.msg. Do not edit."""
import sys
...
class SignalActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "pr_msgs/SignalActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_msgs/SignalFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SignalActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pr_msgs.msg.SignalFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pr_msgs.msg.SignalFeedback()
