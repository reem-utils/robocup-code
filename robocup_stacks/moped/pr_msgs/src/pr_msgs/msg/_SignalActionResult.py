"""autogenerated by genpy from pr_msgs/SignalActionResult.msg. Do not edit."""
import sys
...
class SignalActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pr_msgs/SignalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_msgs/SignalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SignalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pr_msgs.msg.SignalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr_msgs.msg.SignalResult()
