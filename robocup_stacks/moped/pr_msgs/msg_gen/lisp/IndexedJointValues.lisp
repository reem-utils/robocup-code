...
(cl:defmethod cl:initialize-instance :after ((m <IndexedJointValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IndexedJointValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-msg:<IndexedJointValues> is deprecated: use pr_msgs-msg:IndexedJointValues instead.")))

(cl:ensure-generic-function 'jointIndices-val :lambda-list '(m))
(cl:defmethod jointIndices-val ((m <IndexedJointValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:jointIndices-val is deprecated.  Use pr_msgs-msg:jointIndices instead.")
  (jointIndices m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <IndexedJointValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:values-val is deprecated.  Use pr_msgs-msg:values instead.")
  (values m))
