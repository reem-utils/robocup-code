...
(cl:defmethod cl:initialize-instance :after ((m <Joints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-msg:<Joints> is deprecated: use pr_msgs-msg:Joints instead.")))

(cl:ensure-generic-function 'j-val :lambda-list '(m))
(cl:defmethod j-val ((m <Joints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:j-val is deprecated.  Use pr_msgs-msg:j instead.")
  (j m))
