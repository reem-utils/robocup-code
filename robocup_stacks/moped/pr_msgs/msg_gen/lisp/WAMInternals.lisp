...
(cl:defclass <WAMInternals> (roslisp-msg-protocol:ros-message)
  ((positions
   ...
   (gains
    :reader gains
    :initarg :gains
    :type (cl:vector pr_msgs-msg:PIDgains)
   :initform (cl:make-array 0 :element-type 'pr_msgs-msg:PIDgains :initial-element (cl:make-instance 'pr_msgs-msg:PIDgains))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WAMInternals>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WAMInternals)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-msg:<WAMInternals> is deprecated: use pr_msgs-msg:WAMInternals instead.")))
...
(cl:defmethod total_torque-val ((m <WAMInternals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:total_torque-val is deprecated.  Use pr_msgs-msg:total_torque instead.")
  (total_torque m))

(cl:ensure-generic-function 'dynamic_torque-val :lambda-list '(m))
(cl:defmethod dynamic_torque-val ((m <WAMInternals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:dynamic_torque-val is deprecated.  Use pr_msgs-msg:dynamic_torque instead.")
  (dynamic_torque m))

(cl:ensure-generic-function 'trajectory_torque-val :lambda-list '(m))
(cl:defmethod trajectory_torque-val ((m <WAMInternals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:trajectory_torque-val is deprecated.  Use pr_msgs-msg:trajectory_torque instead.")
  (trajectory_torque m))

(cl:ensure-generic-function 'sim_torque-val :lambda-list '(m))
(cl:defmethod sim_torque-val ((m <WAMInternals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:sim_torque-val is deprecated.  Use pr_msgs-msg:sim_torque instead.")
  (sim_torque m))

(cl:ensure-generic-function 'gains-val :lambda-list '(m))
(cl:defmethod gains-val ((m <WAMInternals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_msgs-msg:gains-val is deprecated.  Use pr_msgs-msg:gains instead.")
  (gains m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WAMInternals>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'gains)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'pr_msgs-msg:PIDgains))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WAMInternals>)))
  ...
  "1d5ca374a9297bbc0affedeafe993ccd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WAMInternals)))
  "Returns md5sum for a message object of type 'WAMInternals"
  "1d5ca374a9297bbc0affedeafe993ccd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WAMInternals>)))
  ...
  (cl:format cl:nil "float64[] positions~%float64[] total_torque~%float64[] dynamic_torque~%float64[] trajectory_torque~%float64[] sim_torque~%PIDgains[] gains~%~%================================================================================~%MSG: pr_msgs/PIDgains~%float64 kp~%float64 kd~%float64 ki~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WAMInternals)))
  "Returns full string definition for message of type 'WAMInternals"
  (cl:format cl:nil "float64[] positions~%float64[] total_torque~%float64[] dynamic_torque~%float64[] trajectory_torque~%float64[] sim_torque~%PIDgains[] gains~%~%================================================================================~%MSG: pr_msgs/PIDgains~%float64 kp~%float64 kd~%float64 ki~%~%~%"))
