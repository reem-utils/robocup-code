...
(cl:defmethod cl:initialize-instance :after ((m <WamSetupSeaCtrl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WamSetupSeaCtrl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_msgs-msg:<WamSetupSeaCtrl> is deprecated: use pr_msgs-msg:WamSetupSeaCtrl instead.")))
